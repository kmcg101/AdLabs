        ...
        <div className='textBox'>
            ...
            <div style={textBoxInner} className='textBoxInner'>
                ...
                <div className=''>
                    ...
                    <input className={`standardText ${inputsCheckButtonPressed && allGoodCharacters === false ? "textInputErrorShake" : ""} ${inputsCheckButtonPressed && valueIsValid === false ? "textInputErrorShake" : ""} ${inputsCheckButtonPressedOnce && valueIsValid === false ? "textInputErrorOutline" : ""} ${allGoodCharacters === false ? "textInputErrorOutline" : ""} `}
                        type='text'
                        name={props.varID}
                        value={props.value}
