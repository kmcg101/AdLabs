    ...
    <div>
      <div className="inputsFullPage">
        <div className="inputsLeftColumn">
          <TextBox value={props.inputValues.client} label="CLIENT NAME:" varID="client" handleAnyInputsChange={handleAnyInputsChange} inputsCheckButtonPressed={inputsCheckButtonPressed} inputsCheckButtonPressedOnce={inputsCheckButtonPressedOnce} />
